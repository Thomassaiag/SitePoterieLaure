...
export const CollectionElementPicture = ({collection_element_picture_url, collection_element_picture_alt, collection_element_picture_uid}) => {
  ...
  return (
    <div className='collectionPictureContainer'>
      ...
      {showPopUpPicture && <PopUpPicture imageUrl={collection_element_picture_url} imageAlt={collection_element_picture_alt} imageUid={collection_element_picture_uid} onClose={togglePopUpPicture}/>}
    </div>
  )
}
